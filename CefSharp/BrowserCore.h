...
namespace CefSharp
{
	...
	interface class IDisplayHandler;
    ...
    private:
		...
		IDisplayHandler^ _displayHandler;
    ...
    public:
        ...
        {
            IDisplayHandler^ get() { return _displayHandler; }
            void set(IDisplayHandler^ handler) { _displayHandler = handler; }
        }
